...
class DisplayWaitingRestaurantsService {

  var message;

  var url = Uri.parse(ServerConfig.domainNameServer + ServerConfig.displayWaitingRestaurants);

  Future<List<Restaurants>> displayWaitingRestaurants(var token) async{
    try {
