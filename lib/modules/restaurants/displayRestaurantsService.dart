...
class DisplayRestaurantsService {

  var message;

  var url = Uri.parse(ServerConfig.domainNameServer + ServerConfig.displayRestaurants);

  Future<List<Restaurants>> displayRestaurants(var token) async{
    try {
